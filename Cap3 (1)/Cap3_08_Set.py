...
print(set2 - set1)			# Returneaza elem set 2 mai putin elementele comune cu set 1
...
set1.pop()  					# Sterge un element aleator
print(set1)
set2.pop()
print(set2)
...
print(set1|set2)  # returneaza valori unice din cele 2 siruri (elimina duplicatele)
set2.union(set3)
